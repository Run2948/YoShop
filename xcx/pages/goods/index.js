...
Page({
  ...
  initGoodsDetailData(data) {
    ...
    // 商品价格/划线价/库存
    data.goods_sku_id = data.detail.spec[0].spec_sku_id == undefined ? "" : data.detail.spec[0].spec_sku_id;
  ...
  submit(e) {
    ...
    if (submitType === 'buyNow') {
      ...
      App._post_form('cart/add', {
        goodsId: _this.data.goods_id,
        goodsNum: _this.data.goods_num,
        goodsSkuId: _this.data.goods_sku_id,
      }, function(result) {
